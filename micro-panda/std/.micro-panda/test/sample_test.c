...
void sample_test__add_int(void);
void sample_test__sub_int(void);
void sample_test__invalid_indentation(void);
...
void sample_test__add_int(void) {
  if (!(((1 + 2) == 3))) {
    test___test_fail((__Slice_uint8_t){(uint8_t*)"/Users/sang/Dev/panda-io/micro-panda-dart/micro-panda/std/src/sample_test.mpd", 77}, 5, (__Slice_uint8_t){(uint8_t*)"assert(1 + 2 == 3)", 18});
  } else {
    test___test_pass();
  }
}
...
void sample_test__sub_int(void) {
  if (!(((3 - 1) == 2))) {
    test___test_fail((__Slice_uint8_t){(uint8_t*)"/Users/sang/Dev/panda-io/micro-panda-dart/micro-panda/std/src/sample_test.mpd", 77}, 10, (__Slice_uint8_t){(uint8_t*)"assert(3 - 1 == 2)", 18});
  } else {
    test___test_pass();
  }
}
...
void sample_test__invalid_indentation(void) {
  ...
  const int16_t y = 42;
  if (!((x == y))) {
    test___test_fail((__Slice_uint8_t){(uint8_t*)"/Users/sang/Dev/panda-io/micro-panda-dart/micro-panda/std/src/sample_test.mpd", 77}, 17, (__Slice_uint8_t){(uint8_t*)"assert(x == y)", 14});
  } else {
    test___test_pass();
  }
}
...
int main(void) {
    test___test_begin((__Slice_uint8_t){(uint8_t*)"add_int", 7});
    sample_test__add_int();
    test___test_end();
    test___test_begin((__Slice_uint8_t){(uint8_t*)"sub_int", 7});
    sample_test__sub_int();
    test___test_end();
    test___test_begin((__Slice_uint8_t){(uint8_t*)"invalid_indentation", 19});
    sample_test__invalid_indentation();
    test___test_end();
