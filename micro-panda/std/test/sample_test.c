...
void sample_test__add_int(void) {
  if (!(((1 + 2) == 3))) {
    test___test_fail((__Slice_uint8_t){(uint8_t*)"/Users/sang/Dev/panda-io/micro-panda-dart/micro-panda/src/sample_test.mpd", 73}, 5, (__Slice_uint8_t){(uint8_t*)"assert(1 + 2 == 3)", 18});
  } else {
    test___test_pass();
  }
}
...
void sample_test__sub_int(void) {
  if (!(((3 - 1) == 2))) {
    test___test_fail((__Slice_uint8_t){(uint8_t*)"/Users/sang/Dev/panda-io/micro-panda-dart/micro-panda/src/sample_test.mpd", 73}, 10, (__Slice_uint8_t){(uint8_t*)"assert(3 - 1 == 2)", 18});
  } else {
    test___test_pass();
  }
}
...
void sample_test__invalid_indentation(void) {
  ...
  const int16_t y = 42;
  if (!((x == y))) {
    test___test_fail((__Slice_uint8_t){(uint8_t*)"/Users/sang/Dev/panda-io/micro-panda-dart/micro-panda/src/sample_test.mpd", 73}, 17, (__Slice_uint8_t){(uint8_t*)"assert(x == y)", 14});
  } else {
    test___test_pass();
  }
}
