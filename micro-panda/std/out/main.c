...
int32_t main__main(void) {
  console__print_str((__Slice_uint8_t){(uint8_t*)"Hello, Micro-Panda!", sizeof("Hello, Micro-Panda!") - 1});
  console__println();
  console__print_i32(123);
  console__println();
  console__print_bool(true);
  console__println();
  console__print_float(3.14159f, 2);
  console__println();
  console__print_fixed((-80675), 2);
  console__println();
  const int32_t a = 196608;
  const int32_t b = 131072;
  console__print_fixed(((int32_t)(((int64_t)(a) << 16) / (b))), 2);
  console__println();
  return 0;
}
